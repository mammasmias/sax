...
/* Generated on Mon Mar 24 02:09:04 EST 2003 */

#include "fftw-int.h"
#include "fftw.h"

/* Generated by: /homee/stevenj/cvs/fftw/gensrc/genfft -magic-alignment-check -magic-twiddle-load-all -magic-variables 4 -magic-loopi -hc2hc-backward 16 */
...
/*
 * Generator Id's : 
 * $Id: fhb_16.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: fhb_16.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: fhb_16.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 */

void fftw_hc2hc_backward_16(fftw_real *A, const fftw_complex *W,
			    int iostride, int m, int dist)
{
     ...
     Y = A + (16 * iostride);
     {
	  ...
	  ASSERT_ALIGNED_DOUBLE;
	  {
	       ...
	       tmp277 = X[2 * iostride];
	       tmp278 = X[6 * iostride];
	       tmp306 = tmp277 - tmp278;
	       tmp297 = Y[-2 * iostride];
	       tmp298 = Y[-6 * iostride];
	       tmp307 = tmp297 + tmp298;
	       tmp279 = K2_000000000 * (tmp277 + tmp278);
	       tmp324 = K1_414213562 * (tmp306 + tmp307);
	       tmp308 = K1_414213562 * (tmp306 - tmp307);
	  ...
	  }
	  {
	       ...
	       X[iostride] = tmp320 + tmp313;
	       tmp321 = tmp312 - tmp308;
	       tmp322 = (K1_847759065 * tmp319) + (K765366864 * tmp316);
	       X[5 * iostride] = tmp321 - tmp322;
	       X[13 * iostride] = tmp322 + tmp321;
	  }
	  {
	       fftw_real tmp325;
	       fftw_real tmp328;
	       ...
	       X[3 * iostride] = tmp328 + tmp325;
	       tmp329 = tmp324 + tmp323;
	       tmp330 = (K765366864 * tmp327) + (K1_847759065 * tmp326);
	       X[7 * iostride] = tmp329 - tmp330;
	       X[15 * iostride] = tmp330 + tmp329;
	  }
     }
     X = X + dist;
     Y = Y - dist;
     for (i = 2; i < m; i = i + 2, X = X + dist, Y = Y - dist, W = W + 15) {
	  ...
	  }
	  {
	       ...
	       }
	       {
		    ...
		    tmp171 = c_im(W[11]);
		    Y[-3 * iostride] =
			(tmp167 * tmp170) - (tmp171 * tmp174);
		    X[12 * iostride] =
			(tmp171 * tmp170) + (tmp167 * tmp174);
		    tmp175 = c_re(W[3]);
		    tmp177 = c_im(W[3]);
		    Y[-11 * iostride] =
			(tmp175 * tmp176) - (tmp177 * tmp178);
		    X[4 * iostride] =
			(tmp177 * tmp176) + (tmp175 * tmp178);
	       }
	  }
	  {
	       fftw_real tmp126;
	       ...
	       }
	       {
		    ...
		    tmp127 = c_im(W[9]);
		    X[10 * iostride] =
			(tmp97 * tmp126) + (tmp127 * tmp140);
		    Y[-5 * iostride] =
			(tmp97 * tmp140) - (tmp127 * tmp126);
		    tmp141 = c_re(W[1]);
		    tmp143 = c_im(W[1]);
		    X[2 * iostride] =
			(tmp141 * tmp142) + (tmp143 * tmp144);
		    Y[-13 * iostride] =
			(tmp141 * tmp144) - (tmp143 * tmp142);
	       }
	  }
	  {
	       fftw_real tmp148;
	       ...
	       }
	       {
		    ...
		    X[14 * iostride] =
			(tmp149 * tmp148) + (tmp145 * tmp152);
		    tmp153 = c_re(W[5]);
		    tmp155 = c_im(W[5]);
		    Y[-9 * iostride] =
			(tmp153 * tmp154) - (tmp155 * tmp156);
		    X[6 * iostride] =
			(tmp155 * tmp154) + (tmp153 * tmp156);
	       }
	  }
	  {
	       fftw_real tmp206;
	       ...
	       }
	       {
		    ...
		    tmp207 = c_im(W[12]);
		    X[13 * iostride] =
			(tmp179 * tmp206) + (tmp207 * tmp218);
		    Y[-2 * iostride] =
			(tmp179 * tmp218) - (tmp207 * tmp206);
		    tmp219 = c_re(W[4]);
		    tmp221 = c_im(W[4]);
		    X[5 * iostride] =
			(tmp219 * tmp220) + (tmp221 * tmp222);
		    Y[-10 * iostride] =
			(tmp219 * tmp222) - (tmp221 * tmp220);
	       }
	  }
	  {
	       fftw_real tmp226;
	       ...
	       }
	       {
		    ...
		    tmp227 = c_im(W[8]);
		    Y[-6 * iostride] =
			(tmp223 * tmp226) - (tmp227 * tmp230);
		    X[9 * iostride] =
			(tmp227 * tmp226) + (tmp223 * tmp230);
		    tmp231 = c_re(W[0]);
		    tmp233 = c_im(W[0]);
		    Y[-14 * iostride] =
			(tmp231 * tmp232) - (tmp233 * tmp234);
	  ...
	  }
	  {
	       ...
	       }
	       {
		    ...
		    tmp247 = c_im(W[10]);
		    X[11 * iostride] =
			(tmp235 * tmp246) + (tmp247 * tmp254);
		    Y[-4 * iostride] =
			(tmp235 * tmp254) - (tmp247 * tmp246);
		    tmp255 = c_re(W[2]);
		    tmp257 = c_im(W[2]);
		    X[3 * iostride] =
			(tmp255 * tmp256) + (tmp257 * tmp258);
		    Y[-12 * iostride] =
			(tmp255 * tmp258) - (tmp257 * tmp256);
	       }
	  }
	  {
	       fftw_real tmp262;
	       ...
	       }
	       {
		    ...
		    tmp263 = c_im(W[6]);
		    Y[-8 * iostride] =
			(tmp259 * tmp262) - (tmp263 * tmp266);
		    X[7 * iostride] =
			(tmp263 * tmp262) + (tmp259 * tmp266);
		    tmp267 = c_re(W[14]);
		    tmp269 = c_im(W[14]);
		    Y[0] = (tmp267 * tmp268) - (tmp269 * tmp270);
		    X[15 * iostride] =
			(tmp269 * tmp268) + (tmp267 * tmp270);
	       }
	  }
     }
     if (i == m) {
	  ...
	  X[12 * iostride] = -(K1_414213562 * (tmp63 + tmp66));
	  {
	       ...
	       tmp62 = tmp59 - tmp56;
	       X[6 * iostride] =
		   (K765366864 * tmp61) - (K1_847759065 * tmp62);
	       X[14 * iostride] =
		   -((K1_847759065 * tmp61) + (K765366864 * tmp62));
	       tmp55 = tmp51 + tmp54;
	       tmp60 = tmp56 + tmp59;
	       X[2 * iostride] =
		   (K1_847759065 * tmp55) - (K765366864 * tmp60);
	       X[10 * iostride] =
		   -((K765366864 * tmp55) + (K1_847759065 * tmp60));
	  }
	  {
	       fftw_real tmp45;
	       fftw_real tmp49;
	       ...
	       tmp50 = tmp47 - tmp46;
	       X[3 * iostride] =
		   (K1_662939224 * tmp45) - (K1_111140466 * tmp48);
	       X[11 * iostride] =
		   -((K1_111140466 * tmp45) + (K1_662939224 * tmp48));
	       X[7 * iostride] =
		   (K390180644 * tmp49) - (K1_961570560 * tmp50);
	       X[15 * iostride] =
		   -((K1_961570560 * tmp49) + (K390180644 * tmp50));
	  }
	  {
	       fftw_real tmp31;
	       fftw_real tmp41;
	       ...
	       X[9 * iostride] =
		   -((K390180644 * tmp31) + (K1_961570560 * tmp40));
	       X[5 * iostride] =
		   (K1_111140466 * tmp41) - (K1_662939224 * tmp42);
	       X[13 * iostride] =
		   -((K1_662939224 * tmp41) + (K1_111140466 * tmp42));
	  }
     }
}
