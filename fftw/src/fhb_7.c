...
/* Generated on Mon Mar 24 02:08:54 EST 2003 */

#include "fftw-int.h"
#include "fftw.h"

/* Generated by: /homee/stevenj/cvs/fftw/gensrc/genfft -magic-alignment-check -magic-twiddle-load-all -magic-variables 4 -magic-loopi -hc2hc-backward 7 */
...
/*
 * Generator Id's : 
 * $Id: fhb_7.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: fhb_7.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: fhb_7.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 */

void fftw_hc2hc_backward_7(fftw_real *A, const fftw_complex *W,
			   int iostride, int m, int dist)
{
     ...
     Y = A + (7 * iostride);
     {
	  ...
	  tmp82 = Y[-3 * iostride];
	  tmp84 =
	      (K1_563662964 * tmp81) - (K1_949855824 * tmp82) -
	      (K867767478 * tmp83);
	  tmp88 =
	      (K867767478 * tmp81) + (K1_563662964 * tmp82) -
	      (K1_949855824 * tmp83);
	  tmp86 =
	      (K1_563662964 * tmp83) + (K1_949855824 * tmp81) +
	      (K867767478 * tmp82);
	  tmp76 = X[0];
	  tmp79 = X[3 * iostride];
	  tmp77 = X[iostride];
	  tmp78 = X[2 * iostride];
	  tmp80 =
	      tmp76 + (K1_246979603 * tmp78) - (K445041867 * tmp79) -
	      (K1_801937735 * tmp77);
	  tmp87 =
	      tmp76 + (K1_246979603 * tmp79) - (K1_801937735 * tmp78) -
	      (K445041867 * tmp77);
	  tmp85 =
	      tmp76 + (K1_246979603 * tmp77) - (K1_801937735 * tmp79) -
	      (K445041867 * tmp78);
     ...
     for (i = 2; i < m; i = i + 2, X = X + dist, Y = Y - dist, W = W + 6) {
	  ...
	  ASSERT_ALIGNED_DOUBLE;
	  {
	       ...
	       tmp39 =
		   (K433883739 * tmp36) + (K974927912 * tmp37) -
		   (K781831482 * tmp38);
	       tmp53 =
		   (K781831482 * tmp36) + (K974927912 * tmp38) +
		   (K433883739 * tmp37);
	       tmp66 =
		   (K974927912 * tmp36) - (K781831482 * tmp37) -
		   (K433883739 * tmp38);
	       tmp69 =
		   tmp14 + (K623489801 * tmp23) - (K900968867 * tmp20) -
		   (K222520933 * tmp17);
	       tmp57 =
		   tmp14 + (K623489801 * tmp17) - (K900968867 * tmp23) -
		   (K222520933 * tmp20);
	       tmp42 =
		   tmp14 + (K623489801 * tmp20) - (K222520933 * tmp23) -
		   (K900968867 * tmp17);
	  }
	  {
	       fftw_real tmp44;
	       ...
	       tmp46 =
		   (K781831482 * tmp43) - (K974927912 * tmp44) -
		   (K433883739 * tmp45);
	       tmp58 =
		   (K781831482 * tmp45) + (K974927912 * tmp43) +
		   (K433883739 * tmp44);
	       tmp70 =
		   (K433883739 * tmp43) + (K781831482 * tmp44) -
		   (K974927912 * tmp45);
	       tmp65 =
		   tmp24 + (K623489801 * tmp33) - (K900968867 * tmp30) -
		   (K222520933 * tmp27);
	       tmp54 =
		   tmp24 + (K623489801 * tmp27) - (K900968867 * tmp33) -
		   (K222520933 * tmp30);
	       tmp35 =
		   tmp24 + (K623489801 * tmp30) - (K222520933 * tmp33) -
		   (K900968867 * tmp27);
	  }
     ...
     if (i == m) {
	  ...
	  tmp9 =
	      ...
	      (K867767478 * tmp8);
	  tmp13 =
	      (K1_563662964 * tmp7) - (K1_949855824 * tmp8) -
	      (K867767478 * tmp6);
	  tmp11 =
	  ...
	  tmp3 = X[iostride];
	  tmp5 =
	      (K445041867 * tmp3) + (K1_801937735 * tmp4) -
	      (K1_246979603 * tmp2) - tmp1;
	  tmp12 =
	      (K1_801937735 * tmp2) + (K445041867 * tmp4) -
	      (K1_246979603 * tmp3) - tmp1;
	  tmp10 =
