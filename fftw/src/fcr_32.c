...
/* Generated on Mon Mar 24 02:07:20 EST 2003 */

#include "fftw-int.h"
#include "fftw.h"

/* Generated by: /homee/stevenj/cvs/fftw/gensrc/genfft -magic-alignment-check -magic-twiddle-load-all -magic-variables 4 -magic-loopi -hc2real 32 */
...
/*
 * Generator Id's : 
 * $Id: fcr_32.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: fcr_32.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: fcr_32.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 */

void fftw_hc2real_32(const fftw_real *real_input,
		     ...
		     int real_istride, int imag_istride, int ostride)
{
     ...
     ASSERT_ALIGNED_DOUBLE;
     {
	  ...
	  tmp134 = K1_414213562 * (tmp97 + tmp98);
	  tmp99 = K1_414213562 * (tmp97 - tmp98);
     ...
     }
     {
	  ...
	  tmp80 = tmp55 - tmp52;
	  {
	       ...
	       fftw_real tmp111;
	       ASSERT_ALIGNED_DOUBLE;
	       tmp143 = tmp106 + tmp107;
	       tmp144 = tmp110 - tmp109;
	       tmp145 = (K980785280 * tmp143) - (K195090322 * tmp144);
	       tmp149 = (K195090322 * tmp143) + (K980785280 * tmp144);
	       tmp108 = tmp106 - tmp107;
	       tmp111 = tmp109 + tmp110;
	       tmp112 = (K831469612 * tmp108) - (K555570233 * tmp111);
	       tmp123 = (K555570233 * tmp108) + (K831469612 * tmp111);
	  }
     }
     {
	  fftw_real tmp5;
	  ...
	  ASSERT_ALIGNED_DOUBLE;
	  {
	       ...
	       tmp101 = imag_input[8 * imag_istride];
	       tmp102 = K2_000000000 * tmp101;
	       tmp1 = real_input[0];
     ...
     }
     {
	  ...
	  tmp79 = tmp64 - tmp61;
	  {
	       ...
	       fftw_real tmp118;
	       ASSERT_ALIGNED_DOUBLE;
	       tmp140 = tmp113 + tmp114;
	       tmp141 = tmp117 - tmp116;
	       tmp142 = (K555570233 * tmp140) + (K831469612 * tmp141);
	       tmp148 = (K831469612 * tmp140) - (K555570233 * tmp141);
	       tmp115 = tmp113 - tmp114;
	       tmp118 = tmp116 + tmp117;
	       tmp119 = (K980785280 * tmp115) - (K195090322 * tmp118);
	       tmp122 = (K195090322 * tmp115) + (K980785280 * tmp118);
	  }
     }
     {
	  fftw_real tmp33;
     ...
     }
     {
	  ...
	  ASSERT_ALIGNED_DOUBLE;
	  {
	       ...
	       tmp69 = (K765366864 * tmp57) + (K1_847759065 * tmp66);
	  }
     ...
     }
     {
	  ...
	  ASSERT_ALIGNED_DOUBLE;
	  {
	       ...
	       tmp77 = (K1_847759065 * tmp73) + (K765366864 * tmp74);
	  }
     ...
     }
     {
	  ...
	  tmp96 = (K1_847759065 * tmp92) - (K765366864 * tmp95);
	  tmp104 = tmp99 + tmp103;
	  tmp105 = tmp96 + tmp104;
	  tmp121 = tmp104 - tmp96;
	  output[17 * ostride] = tmp105 - tmp120;
	  output[ostride] = tmp120 + tmp105;
	  output[9 * ostride] = tmp121 - tmp124;
	  output[25 * ostride] = tmp124 + tmp121;
     }
     {
	  fftw_real tmp127;
	  fftw_real tmp131;
     ...
     }
     {
	  ...
	  tmp147 = tmp138 + tmp135;
	  output[11 * ostride] = tmp139 - tmp146;
	  output[27 * ostride] = tmp146 + tmp139;
	  output[19 * ostride] = tmp147 - tmp150;
	  output[3 * ostride] = tmp150 + tmp147;
     }
     {
	  fftw_real tmp153;
	  fftw_real tmp157;
	  ...
	  ASSERT_ALIGNED_DOUBLE;
	  {
	       ...
	       fftw_real tmp155;
	       ASSERT_ALIGNED_DOUBLE;
	       tmp151 = tmp134 + tmp133;
	       tmp152 = (K1_847759065 * tmp136) + (K765366864 * tmp137);
	       tmp153 = tmp151 - tmp152;
	       tmp157 = tmp152 + tmp151;
	       tmp154 = tmp149 + tmp148;
	       tmp155 = tmp145 + tmp142;
	       tmp156 = K1_414213562 * (tmp154 - tmp155);
	       tmp158 = K1_414213562 * (tmp154 + tmp155);
	  }
	  output[23 * ostride] = tmp153 - tmp156;
	  output[7 * ostride] = tmp156 + tmp153;
	  output[15 * ostride] = tmp157 - tmp158;
	  output[31 * ostride] = tmp158 + tmp157;
     }
}
