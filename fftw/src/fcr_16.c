...
/* Generated on Mon Mar 24 02:07:18 EST 2003 */

#include "fftw-int.h"
#include "fftw.h"

/* Generated by: /homee/stevenj/cvs/fftw/gensrc/genfft -magic-alignment-check -magic-twiddle-load-all -magic-variables 4 -magic-loopi -hc2real 16 */
...
/*
 * Generator Id's : 
 * $Id: fcr_16.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: fcr_16.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: fcr_16.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 */

void fftw_hc2real_16(const fftw_real *real_input,
		     ...
		     int real_istride, int imag_istride, int ostride)
{
     ...
     ASSERT_ALIGNED_DOUBLE;
     {
	  ...
	  tmp54 = K1_414213562 * (tmp36 + tmp37);
	  tmp38 = K1_414213562 * (tmp36 - tmp37);
     ...
     }
     {
	  ...
	  ASSERT_ALIGNED_DOUBLE;
	  {
	       ...
	       tmp40 = imag_input[4 * imag_istride];
	       tmp41 = K2_000000000 * tmp40;
	       tmp1 = real_input[0];
