...
/* Generated on Mon Mar 24 02:07:07 EST 2003 */

#include "fftw-int.h"
#include "fftw.h"

/* Generated by: /homee/stevenj/cvs/fftw/gensrc/genfft -magic-alignment-check -magic-twiddle-load-all -magic-variables 4 -magic-loopi -hc2real 12 */
...
/*
 * Generator Id's : 
 * $Id: fcr_12.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: fcr_12.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: fcr_12.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 */

void fftw_hc2real_12(const fftw_real *real_input,
		     ...
		     int real_istride, int imag_istride, int ostride)
{
     ...
     ASSERT_ALIGNED_DOUBLE;
     {
	  ...
	  tmp37 = tmp33 + (K2_000000000 * tmp32);
     }
     {
	  fftw_real tmp15;
	  fftw_real tmp1;
