...
/*
 * Generator Id's : 
 * $Id: fhf_9.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: fhf_9.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: fhf_9.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 */
			  ...
			  int iostride, int m, int dist)
{
     ...
     if (i == m) {
	  ...
	  tmp3 = X[3 * iostride];
	  tmp2 = X[6 * iostride];
	  tmp17 = K866025403 * (tmp2 + tmp3);
	  tmp19 = tmp1 + tmp2 - tmp3;
	  tmp4 = tmp1 - (K500000000 * (tmp2 - tmp3));
	  tmp9 = X[4 * iostride];
	  tmp11 = X[7 * iostride];
	  tmp10 = X[iostride];
	  tmp12 =
	      (K347296355 * tmp9) + (K1_879385241 * tmp10) -
	      (K1_532088886 * tmp11);
	  tmp23 =
	      (K1_879385241 * tmp9) + (K1_532088886 * tmp10) +
	      (K347296355 * tmp11);
	  tmp15 =
	      (K1_969615506 * tmp9) + (K684040286 * tmp10) +
	      (K1_285575219 * tmp11);
	  tmp21 =
	      (K1_285575219 * tmp10) - (K1_969615506 * tmp11) -
	      (K684040286 * tmp9);
	  tmp5 = X[2 * iostride];
	  tmp7 = X[8 * iostride];
	  tmp6 = X[5 * iostride];
	  tmp8 =
	      (K1_532088886 * tmp5) - (K347296355 * tmp6) -
	      (K1_879385241 * tmp7);
	  tmp22 =
	      (K347296355 * tmp5) + (K1_532088886 * tmp7) +
	      (K1_879385241 * tmp6);
	  tmp14 =
	      (K1_285575219 * tmp5) + (K684040286 * tmp7) +
	      (K1_969615506 * tmp6);
	  tmp18 = tmp6 - (tmp5 + tmp7);
	  tmp20 =
	      (K1_285575219 * tmp7) - (K684040286 * tmp6) -
	      (K1_969615506 * tmp5);
	  Y[-iostride] = K866025403 * (tmp9 + tmp18 - (tmp10 + tmp11));
	  X[iostride] =
	      tmp19 + (K500000000 * (tmp18 + tmp10 + tmp11 - tmp9));
	  X[4 * iostride] =
	      tmp19 + tmp5 + tmp7 + tmp9 - (tmp6 + tmp10 + tmp11);
	  X[2 * iostride] =
	      tmp4 + (K250000000 * (tmp23 - tmp22)) +
	      (K433012701 * (tmp20 - tmp21));
	  Y[-2 * iostride] =
	      tmp17 - (K250000000 * (tmp20 + tmp21)) -
	      (K433012701 * (tmp22 + tmp23));
	  tmp16 = tmp14 + tmp15;
	  Y[0] = -(tmp17 + (K500000000 * tmp16));
	  Y[-3 * iostride] =
	      (K250000000 * tmp16) - (K433012701 * (tmp12 - tmp8)) - tmp17;
	  tmp13 = tmp8 + tmp12;
	  X[0] = tmp4 + (K500000000 * tmp13);
	  X[3 * iostride] =
	      tmp4 + (K433012701 * (tmp14 - tmp15)) - (K250000000 * tmp13);
     }
}
