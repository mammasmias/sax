...
/* Generated by: /homee/stevenj/cvs/fftw/gensrc/genfft -magic-alignment-check -magic-twiddle-load-all -magic-variables 4 -magic-loopi -real2hc 14 */
...
/*
 * Generator Id's : 
 * $Id: frc_14.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: frc_14.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: frc_14.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 */

void fftw_real2hc_14(const fftw_real *input, fftw_real *real_output,
		     ...
		     int imag_ostride)
{
     ...
     tmp37 = tmp1 + tmp2;
     {
	  ...
	  tmp5 = input[13 * istride];
	  tmp6 = tmp4 - tmp5;
	  tmp31 = tmp4 + tmp5;
	  tmp21 = input[10 * istride];
     ...
     }
     {
	  ...
	  tmp19 = input[11 * istride];
	  tmp20 = tmp18 - tmp19;
	  tmp34 = tmp18 + tmp19;
	  tmp11 = input[2 * istride];
	  tmp12 = input[9 * istride];
	  tmp13 = tmp11 - tmp12;
	  tmp29 = tmp11 + tmp12;
     }
     {
	  ...
	  fftw_real tmp15;
	  ASSERT_ALIGNED_DOUBLE;
	  tmp7 = input[8 * istride];
	  tmp8 = input[istride];
	  tmp9 = tmp7 - tmp8;
	  tmp32 = tmp7 + tmp8;
	  tmp14 = input[12 * istride];
	  tmp15 = input[5 * istride];
	  tmp16 = tmp14 - tmp15;
	  tmp28 = tmp14 + tmp15;
     }
     {
	  ...
	  imag_output[5 * imag_ostride] =
	      -((K974927912 * tmp25) - (K781831482 * tmp26) -
		(K433883739 * tmp27));
	  imag_output[3 * imag_ostride] =
	      (K974927912 * tmp26) + (K433883739 * tmp25) -
	      (K781831482 * tmp27);
	  imag_output[imag_ostride] =
	      (K974927912 * tmp27) + (K433883739 * tmp26) +
	      (K781831482 * tmp25);
	  tmp10 = tmp6 + tmp9;
	  tmp24 = tmp20 + tmp23;
	  tmp17 = tmp13 + tmp16;
	  real_output[5 * real_ostride] =
	      tmp3 + (K623489801 * tmp10) - (K222520933 * tmp17) -
	      (K900968867 * tmp24);
	  ...
	  real_output[real_ostride] =
	      tmp3 + (K623489801 * tmp17) - (K900968867 * tmp10) -
	      (K222520933 * tmp24);
     }
     {
	  fftw_real tmp30;
	  ...
	  imag_output[6 * imag_ostride] =
	      -((K781831482 * tmp30) - (K433883739 * tmp33) -
		(K974927912 * tmp36));
	  imag_output[2 * imag_ostride] =
	      (K433883739 * tmp36) + (K781831482 * tmp33) +
	      (K974927912 * tmp30);
	  imag_output[4 * imag_ostride] =
	      -((K781831482 * tmp36) + (K433883739 * tmp30) -
		(K974927912 * tmp33));
	  tmp38 = tmp31 + tmp32;
	  tmp40 = tmp34 + tmp35;
	  tmp39 = tmp29 + tmp28;
	  real_output[2 * real_ostride] =
	      tmp37 + (K623489801 * tmp38) - (K222520933 * tmp39) -
	      (K900968867 * tmp40);
	  real_output[0] = tmp37 + tmp40 + tmp38 + tmp39;
	  real_output[4 * real_ostride] =
	      tmp37 + (K623489801 * tmp40) - (K900968867 * tmp39) -
	      (K222520933 * tmp38);
	  real_output[6 * real_ostride] =
	      tmp37 + (K623489801 * tmp39) - (K900968867 * tmp38) -
	      (K222520933 * tmp40);
     }
}
