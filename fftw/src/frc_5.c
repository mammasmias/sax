...
/* Generated by: /homee/stevenj/cvs/fftw/gensrc/genfft -magic-alignment-check -magic-twiddle-load-all -magic-variables 4 -magic-loopi -real2hc 5 */
...
/*
 * Generator Id's : 
 * $Id: frc_5.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: frc_5.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: frc_5.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 */

void fftw_real2hc_5(const fftw_real *input, fftw_real *real_output,
		    ...
		    int imag_ostride)
{
	 ...
	 -((K951056516 * tmp3) + (K587785252 * tmp6));
     imag_output[2 * imag_ostride] =
	 (K951056516 * tmp6) - (K587785252 * tmp3);
     real_output[0] = tmp11 + tmp10;
