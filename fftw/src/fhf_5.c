...
/* Generated on Mon Mar 24 02:07:49 EST 2003 */

#include "fftw-int.h"
#include "fftw.h"

/* Generated by: /homee/stevenj/cvs/fftw/gensrc/genfft -magic-alignment-check -magic-twiddle-load-all -magic-variables 4 -magic-loopi -hc2hc-forward 5 */
...
/*
 * Generator Id's : 
 * $Id: fhf_5.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: fhf_5.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: fhf_5.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 */

void fftw_hc2hc_forward_5(fftw_real *A, const fftw_complex *W,
			  int iostride, int m, int dist)
{
     ...
     if (i == m) {
	  ...
	  Y[0] = -((K951056516 * tmp3) + (K587785252 * tmp6));
	  Y[-iostride] = -((K951056516 * tmp6) - (K587785252 * tmp3));
	  X[2 * iostride] = tmp11 + tmp10;
	  tmp9 = K559016994 * (tmp7 - tmp8);
	  tmp12 = tmp10 - (K250000000 * tmp11);
	  X[0] = tmp9 + tmp12;
	  X[iostride] = tmp12 - tmp9;
     }
}
