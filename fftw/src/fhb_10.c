...
/*
 * Generator Id's : 
 * $Id: fhb_10.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: fhb_10.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: fhb_10.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 */
			    ...
			    int iostride, int m, int dist)
{
     ...
     for (i = 2; i < m; i = i + 2, X = X + dist, Y = Y - dist, W = W + 9) {
	  ...
	  }
	  {
	       ...
	       }
	       {
		    ...
		    tmp134 = tmp115 + tmp116;
		    tmp133 = tmp112 + tmp113;
	  ...
	  }
	  {
	       ...
	       tmp125 = tmp119 - (K250000000 * tmp118);
	       ...
	       tmp146 = tmp131 + tmp130;
	       {
		    ...
		    tmp129 = c_im(W[6]);
		    Y[-2 * iostride] =
			(tmp121 * tmp128) - (tmp129 * tmp136);
		    X[7 * iostride] =
			(tmp121 * tmp136) + (tmp129 * tmp128);
	       }
	       {
		    fftw_real tmp138;
		    fftw_real tmp140;
		    ...
		    tmp139 = c_im(W[2]);
		    Y[-6 * iostride] =
			(tmp137 * tmp138) - (tmp139 * tmp140);
		    X[3 * iostride] =
			(tmp137 * tmp140) + (tmp139 * tmp138);
	       }
	       {
		    fftw_real tmp144;
		    fftw_real tmp148;
		    ...
		    tmp145 = c_im(W[0]);
		    Y[-8 * iostride] =
			(tmp141 * tmp144) - (tmp145 * tmp148);
		    X[iostride] = (tmp141 * tmp148) + (tmp145 * tmp144);
	       }
	       {
		    fftw_real tmp150;
		    fftw_real tmp152;
     ...
     if (i == m) {
	  ...
	  }
	  {
	       ...
	       tmp21 = tmp15 + tmp16;
	       tmp14 = tmp12 - tmp13;
	       tmp28 = K1_118033988 * (tmp22 + tmp21);
	       tmp23 = tmp21 - tmp22;
	       tmp17 = tmp15 - tmp16;
	  }
	  X[0] = K2_000000000 * (tmp1 + tmp8);
	  {
	       ...
	       tmp19 = (K1_902113032 * tmp14) + (K1_175570504 * tmp17);
