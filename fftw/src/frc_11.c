...
/* Generated by: /homee/stevenj/cvs/fftw/gensrc/genfft -magic-alignment-check -magic-twiddle-load-all -magic-variables 4 -magic-loopi -real2hc 11 */
...
/*
 * Generator Id's : 
 * $Id: frc_11.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: frc_11.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: frc_11.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 */

void fftw_real2hc_11(const fftw_real *input, fftw_real *real_output,
		     ...
		     int imag_ostride)
{
     ...
     tmp1 = input[0];
     {
	  ...
	  tmp4 = tmp2 + tmp3;
	  tmp20 = tmp3 - tmp2;
	  tmp14 = input[2 * istride];
	  tmp15 = input[9 * istride];
	  tmp16 = tmp14 + tmp15;
	  tmp21 = tmp15 - tmp14;
     }
     tmp11 = input[4 * istride];
     tmp12 = input[7 * istride];
     tmp13 = tmp11 + tmp12;
     tmp17 = tmp12 - tmp11;
     {
	  fftw_real tmp8;
	  ...
	  tmp6 = input[8 * istride];
	  tmp7 = tmp5 + tmp6;
	  tmp18 = tmp6 - tmp5;
     }
     imag_output[4 * imag_ostride] =
	 (K281732556 * tmp17) + (K540640817 * tmp18) +
	 (K755749574 * tmp19) - (K909631995 * tmp20) -
	 (K989821441 * tmp21);
     imag_output[imag_ostride] =
	 (K909631995 * tmp21) + (K755749574 * tmp17) +
	 (K281732556 * tmp20) + (K989821441 * tmp18) +
	 (K540640817 * tmp19);
     imag_output[5 * imag_ostride] =
	 (K989821441 * tmp20) + (K755749574 * tmp18) +
	 (K281732556 * tmp19) - (K909631995 * tmp17) -
	 (K540640817 * tmp21);
     imag_output[2 * imag_ostride] =
	 (K755749574 * tmp21) + (K909631995 * tmp19) -
	 (K281732556 * tmp18) - (K540640817 * tmp20) -
	 (K989821441 * tmp17);
     imag_output[3 * imag_ostride] =
	 (K540640817 * tmp17) + (K755749574 * tmp20) +
	 (K989821441 * tmp19) - (K909631995 * tmp18) -
	 (K281732556 * tmp21);
     real_output[2 * real_ostride] =
	 tmp1 + (K841253532 * tmp4) + (K415415013 * tmp10) -
	 (K959492973 * tmp7) - (K142314838 * tmp13) - (K654860733 * tmp16);
     real_output[4 * real_ostride] =
	 tmp1 + (K415415013 * tmp4) + (K841253532 * tmp7) -
	 (K654860733 * tmp10) - (K959492973 * tmp13) -
	 (K142314838 * tmp16);
     real_output[5 * real_ostride] =
	 tmp1 + (K841253532 * tmp16) + (K415415013 * tmp13) -
	 (K959492973 * tmp10) - (K654860733 * tmp7) - (K142314838 * tmp4);
     real_output[real_ostride] =
	 tmp1 + (K415415013 * tmp16) + (K841253532 * tmp10) -
	 (K142314838 * tmp7) - (K959492973 * tmp4) - (K654860733 * tmp13);
     real_output[3 * real_ostride] =
	 tmp1 + (K841253532 * tmp13) + (K415415013 * tmp7) -
	 (K142314838 * tmp10) - (K654860733 * tmp4) - (K959492973 * tmp16);
     real_output[0] = tmp1 + tmp16 + tmp13 + tmp4 + tmp7 + tmp10;
}
