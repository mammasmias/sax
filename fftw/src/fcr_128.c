...
/* Generated on Mon Mar 24 02:07:28 EST 2003 */

#include "fftw-int.h"
#include "fftw.h"

/* Generated by: /homee/stevenj/cvs/fftw/gensrc/genfft -magic-alignment-check -magic-twiddle-load-all -magic-variables 4 -magic-loopi -hc2real 128 */
...
static const fftw_real K857728610 =
...
/*
 * Generator Id's : 
 * $Id: fcr_128.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: fcr_128.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: fcr_128.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 */

void fftw_hc2real_128(const fftw_real *real_input,
		      ...
		      int real_istride, int imag_istride, int ostride)
{
     ...
     ASSERT_ALIGNED_DOUBLE;
     {
	  ...
	  ASSERT_ALIGNED_DOUBLE;
	  {
	       ...
	       tmp579 = imag_input[32 * imag_istride];
	       tmp580 = K2_000000000 * tmp579;
	       tmp1 = real_input[0];
	  ...
	  tmp326 = tmp130 + tmp133;
	  {
	       ...
	       fftw_real tmp784;
	       ASSERT_ALIGNED_DOUBLE;
	       tmp577 = K1_414213562 * (tmp575 - tmp576);
	       tmp581 = tmp578 - tmp580;
	       tmp582 = tmp577 + tmp581;
	       tmp715 = tmp581 - tmp577;
	       tmp783 = tmp578 + tmp580;
	       tmp784 = K1_414213562 * (tmp575 + tmp576);
	       tmp785 = tmp783 - tmp784;
	       tmp901 = tmp784 + tmp783;
	  }
     }
     {
	  fftw_real tmp13;
	  ...
	  tmp455 = K2_000000000 * (tmp141 - tmp138);
	  {
	       ...
	       tmp574 = (K1_847759065 * tmp570) - (K765366864 * tmp573);
	       tmp716 = (K765366864 * tmp570) + (K1_847759065 * tmp573);
	       tmp780 = tmp568 + tmp569;
	       tmp781 = tmp572 - tmp571;
	       tmp782 = (K765366864 * tmp780) - (K1_847759065 * tmp781);
	       tmp902 = (K1_847759065 * tmp780) + (K765366864 * tmp781);
	  }
     }
     {
	  fftw_real tmp104;
	  ...
	  ASSERT_ALIGNED_DOUBLE;
	  {
	       ...
	       tmp819 = tmp624 + tmp625;
	       tmp629 = tmp627 + tmp628;
	       tmp820 = tmp628 - tmp627;
	  }
	  {
	       fftw_real tmp122;
	       fftw_real tmp632;
	       ...
	       tmp829 = tmp632 + tmp633;
	       tmp637 = tmp635 + tmp636;
	       tmp830 = tmp636 - tmp635;
	  }
	  {
	       fftw_real tmp107;
	       fftw_real tmp617;
	       ...
	       tmp822 = tmp617 + tmp618;
	       tmp622 = tmp620 + tmp621;
	       tmp823 = tmp621 - tmp620;
	  }
	  {
	       fftw_real tmp115;
	       fftw_real tmp639;
	       ...
	       tmp826 = tmp639 + tmp640;
	       tmp644 = tmp642 + tmp643;
	       tmp827 = tmp643 - tmp642;
	  }
	  {
	       fftw_real tmp828;
	       fftw_real tmp831;
	       ...
	       ASSERT_ALIGNED_DOUBLE;
	       {
		    ...
		    tmp477 = tmp410 + tmp409;
		    tmp478 = tmp476 - tmp477;
		    tmp507 = tmp476 + tmp477;
		    tmp411 = tmp409 - tmp410;
		    tmp638 = (K857728610 * tmp634) - (K514102744 * tmp637);
		    tmp645 = (K970031253 * tmp641) - (K242980179 * tmp644);
		    tmp646 = tmp638 + tmp645;
		    tmp731 = tmp638 - tmp645;
	       }
	       {
		    fftw_real tmp660;
		    fftw_real tmp661;
		    ...
		    fftw_real tmp847;
		    ASSERT_ALIGNED_DOUBLE;
		    tmp660 = (K242980179 * tmp641) + (K970031253 * tmp644);
		    tmp661 = (K514102744 * tmp634) + (K857728610 * tmp637);
		    tmp662 = tmp660 - tmp661;
		    tmp728 = tmp661 + tmp660;
		    tmp846 = (K740951125 * tmp826) - (K671558954 * tmp827);
		    tmp847 = (K049067674 * tmp829) + (K998795456 * tmp830);
		    tmp848 = tmp846 - tmp847;
		    tmp917 = tmp847 + tmp846;
	       }
	       tmp828 = (K671558954 * tmp826) + (K740951125 * tmp827);
	       tmp831 = (K998795456 * tmp829) - (K049067674 * tmp830);
	       tmp832 = tmp828 - tmp831;
	       tmp914 = tmp831 + tmp828;
	       {
		    fftw_real tmp821;
		    fftw_real tmp824;
		    fftw_real tmp843;
		    ...
		    tmp916 = tmp824 + tmp821;
		    tmp843 = (K903989293 * tmp819) - (K427555093 * tmp820);
		    tmp844 = (K336889853 * tmp822) + (K941544065 * tmp823);
		    tmp845 = tmp843 - tmp844;
		    tmp913 = tmp844 + tmp843;
	       }
	       {
		    fftw_real tmp479;
		    fftw_real tmp480;
		    ...
		    tmp288 = (K290284677 * tmp252) + (K956940335 * tmp261);
	       }
	       {
		    fftw_real tmp348;
		    fftw_real tmp349;
		    ...
		    tmp360 = (K773010453 * tmp348) + (K634393284 * tmp349);
		    tmp657 = (K146730474 * tmp626) + (K989176509 * tmp629);
		    tmp658 = (K595699304 * tmp619) + (K803207531 * tmp622);
		    tmp659 = tmp657 - tmp658;
		    tmp730 = tmp658 + tmp657;
	       }
	       tmp623 = (K803207531 * tmp619) - (K595699304 * tmp622);
	       tmp630 = (K989176509 * tmp626) - (K146730474 * tmp629);
	       tmp631 = tmp623 + tmp630;
	       tmp727 = tmp630 - tmp623;
	       {
		    fftw_real tmp271;
		    fftw_real tmp280;
		    fftw_real tmp351;
		    ...
		    tmp289 = (K471396736 * tmp271) + (K881921264 * tmp280);
		    tmp351 = tmp263 + tmp270;
		    tmp352 = tmp279 - tmp272;
		    tmp353 = (K098017140 * tmp351) - (K995184726 * tmp352);
		    tmp361 = (K995184726 * tmp351) + (K098017140 * tmp352);
	       }
	  }
     }
     {
	  ...
	  ASSERT_ALIGNED_DOUBLE;
	  {
	       ...
	       tmp561 = tmp155 + tmp156;
	       tmp21 = tmp19 + tmp20;
	       tmp773 = tmp560 + tmp561;
	  ...
	  }
	  {
	       ...
	       tmp564 = tmp158 + tmp159;
	       tmp24 = tmp22 + tmp23;
	       tmp774 = tmp564 - tmp563;
	  ...
	  }
	  {
	       ...
	       tmp554 = tmp146 + tmp147;
	       tmp28 = tmp26 + tmp27;
	       tmp776 = tmp553 + tmp554;
	  ...
	  }
	  {
	       ...
	       tmp557 = tmp149 + tmp150;
	       tmp31 = tmp29 + tmp30;
	       tmp777 = tmp557 - tmp556;
	  ...
	  }
	  {
	       ...
	       tmp458 = tmp430 + tmp429;
	       tmp154 = tmp31 - tmp28;
	       tmp161 = tmp157 + tmp160;
	       tmp162 = tmp154 + tmp161;
	       tmp330 = tmp161 - tmp154;
	  }
	  tmp559 = (K831469612 * tmp555) - (K555570233 * tmp558);
	  tmp566 = (K980785280 * tmp562) - (K195090322 * tmp565);
	  tmp712 = tmp566 - tmp559;
	  tmp683 = (K195090322 * tmp562) + (K980785280 * tmp565);
	  tmp684 = (K555570233 * tmp555) + (K831469612 * tmp558);
	  tmp713 = tmp684 + tmp683;
	  tmp775 = (K831469612 * tmp773) - (K555570233 * tmp774);
	  tmp778 = (K195090322 * tmp776) + (K980785280 * tmp777);
	  tmp898 = tmp778 + tmp775;
	  tmp865 = (K555570233 * tmp773) + (K831469612 * tmp774);
	  tmp866 = (K980785280 * tmp776) - (K195090322 * tmp777);
	  tmp899 = tmp866 + tmp865;
     }
     {
	  fftw_real tmp37;
	  fftw_real tmp180;
	  ...
	  ASSERT_ALIGNED_DOUBLE;
	  {
	       ...
	       }
	       {
		    ...
		    tmp530 = tmp175 + tmp176;
	       }
	       tmp165 = tmp37 - tmp40;
	       tmp534 = tmp532 + tmp533;
	       tmp789 = tmp533 - tmp532;
	       tmp788 = tmp529 + tmp530;
	       tmp531 = tmp529 - tmp530;
	  ...
	  }
	  {
	       ...
	       }
	       {
		    ...
		    tmp523 = tmp166 + tmp167;
	       }
	       tmp172 = tmp168 + tmp171;
	       tmp527 = tmp525 + tmp526;
	       tmp792 = tmp526 - tmp525;
	       tmp791 = tmp522 + tmp523;
	  ...
	  }
	  {
	       ...
	       tmp49 = tmp41 + tmp48;
	       tmp461 = tmp41 - tmp48;
	       tmp666 = (K098017140 * tmp531) + (K995184726 * tmp534);
	       tmp667 = (K634393284 * tmp524) + (K773010453 * tmp527);
	       tmp668 = tmp666 - tmp667;
	       tmp708 = tmp667 + tmp666;
	  }
	  {
	       fftw_real tmp852;
	       fftw_real tmp853;
	       ...
	       fftw_real tmp793;
	       ASSERT_ALIGNED_DOUBLE;
	       tmp852 = (K290284677 * tmp788) + (K956940335 * tmp789);
	       tmp853 = (K881921264 * tmp791) - (K471396736 * tmp792);
	       tmp854 = tmp852 - tmp853;
	       tmp894 = tmp853 + tmp852;
	       tmp790 = (K956940335 * tmp788) - (K290284677 * tmp789);
	       tmp793 = (K471396736 * tmp791) + (K881921264 * tmp792);
	       tmp794 = tmp790 - tmp793;
	       tmp891 = tmp793 + tmp790;
	  }
	  {
	       fftw_real tmp528;
	       fftw_real tmp535;
	       ...
	       fftw_real tmp334;
	       ASSERT_ALIGNED_DOUBLE;
	       tmp528 = (K773010453 * tmp524) - (K634393284 * tmp527);
	       tmp535 = (K995184726 * tmp531) - (K098017140 * tmp534);
	       tmp536 = tmp528 + tmp535;
	       tmp705 = tmp535 - tmp528;
	       tmp333 = tmp165 + tmp172;
	       tmp334 = tmp181 - tmp174;
	       tmp335 = (K831469612 * tmp333) - (K555570233 * tmp334);
	       tmp365 = (K555570233 * tmp333) + (K831469612 * tmp334);
	  }
	  {
	       fftw_real tmp173;
	       fftw_real tmp182;
	       ...
	       tmp293 = (K195090322 * tmp173) + (K980785280 * tmp182);
	       tmp415 = tmp180 - tmp177;
	       tmp416 = tmp171 - tmp168;
	       tmp417 = tmp415 - tmp416;
	       tmp465 = tmp416 + tmp415;
	  }
     }
     {
	  fftw_real tmp52;
	  ...
	  ASSERT_ALIGNED_DOUBLE;
	  {
	       ...
	       }
	       {
		    ...
		    tmp545 = tmp194 + tmp195;
	       }
	       tmp184 = tmp52 - tmp55;
	       tmp549 = tmp547 + tmp548;
	       tmp799 = tmp548 - tmp547;
	       tmp798 = tmp544 + tmp545;
	  ...
	  }
	  {
	       ...
	       }
	       {
		    ...
		    tmp538 = tmp185 + tmp186;
	       }
	       tmp191 = tmp187 + tmp190;
	       tmp542 = tmp540 + tmp541;
	       tmp796 = tmp541 - tmp540;
	       tmp795 = tmp537 + tmp538;
	  ...
	  }
	  {
	       ...
	       tmp64 = tmp56 + tmp63;
	       tmp464 = tmp63 - tmp56;
	       tmp669 = (K290284677 * tmp546) + (K956940335 * tmp549);
	       tmp670 = (K471396736 * tmp539) + (K881921264 * tmp542);
	       tmp671 = tmp669 - tmp670;
	       tmp706 = tmp670 + tmp669;
	  }
	  {
	       fftw_real tmp855;
	       fftw_real tmp856;
	       ...
	       fftw_real tmp800;
	       ASSERT_ALIGNED_DOUBLE;
	       tmp855 = (K773010453 * tmp798) + (K634393284 * tmp799);
	       tmp856 = (K995184726 * tmp795) + (K098017140 * tmp796);
	       tmp857 = tmp855 - tmp856;
	       tmp892 = tmp856 + tmp855;
	       tmp797 = (K098017140 * tmp795) - (K995184726 * tmp796);
	       tmp800 = (K634393284 * tmp798) - (K773010453 * tmp799);
	       tmp801 = tmp797 + tmp800;
	       tmp895 = tmp797 - tmp800;
	  }
	  {
	       fftw_real tmp543;
	       fftw_real tmp550;
	       ...
	       fftw_real tmp337;
	       ASSERT_ALIGNED_DOUBLE;
	       tmp543 = (K881921264 * tmp539) - (K471396736 * tmp542);
	       tmp550 = (K956940335 * tmp546) - (K290284677 * tmp549);
	       tmp551 = tmp543 + tmp550;
	       tmp709 = tmp543 - tmp550;
	       tmp336 = tmp184 + tmp191;
	       tmp337 = tmp200 - tmp193;
	       tmp338 = (K195090322 * tmp336) + (K980785280 * tmp337);
	       tmp366 = (K980785280 * tmp336) - (K195090322 * tmp337);
	  }
	  {
	       fftw_real tmp192;
	       fftw_real tmp201;
	       ...
	       tmp294 = (K555570233 * tmp192) + (K831469612 * tmp201);
	       tmp418 = tmp199 - tmp196;
	       tmp419 = tmp190 - tmp187;
	       tmp420 = tmp418 - tmp419;
	       tmp462 = tmp419 + tmp418;
	  }
     }
     {
	  fftw_real tmp73;
	  ...
	  ASSERT_ALIGNED_DOUBLE;
	  {
	       ...
	       tmp804 = tmp593 + tmp594;
	       tmp598 = tmp596 + tmp597;
	       tmp805 = tmp597 - tmp596;
	  }
	  {
	       fftw_real tmp91;
	       fftw_real tmp601;
	       ...
	       tmp814 = tmp601 + tmp602;
	       tmp606 = tmp604 + tmp605;
	       tmp815 = tmp605 - tmp604;
	  }
	  {
	       fftw_real tmp76;
	       fftw_real tmp586;
	       ...
	       tmp807 = tmp586 + tmp587;
	       tmp591 = tmp589 + tmp590;
	       tmp808 = tmp590 - tmp589;
	  }
	  {
	       fftw_real tmp84;
	       fftw_real tmp608;
	       ...
	       tmp811 = tmp608 + tmp609;
	       tmp613 = tmp611 + tmp612;
	       tmp812 = tmp612 - tmp611;
	  }
	  {
	       fftw_real tmp813;
	       fftw_real tmp816;
	       ...
	       ASSERT_ALIGNED_DOUBLE;
	       {
		    ...
		    tmp81 = tmp73 + tmp80;
		    tmp469 = tmp73 - tmp80;
		    tmp470 = tmp403 + tmp402;
		    tmp471 = tmp469 - tmp470;
		    tmp503 = tmp469 + tmp470;
		    tmp404 = tmp402 - tmp403;
		    tmp607 = (K903989293 * tmp603) - (K427555093 * tmp606);
		    tmp614 = (K941544065 * tmp610) - (K336889853 * tmp613);
		    tmp615 = tmp607 + tmp614;
		    tmp724 = tmp607 - tmp614;
	       }
	       {
		    fftw_real tmp653;
		    fftw_real tmp654;
		    ...
		    fftw_real tmp840;
		    ASSERT_ALIGNED_DOUBLE;
		    tmp653 = (K336889853 * tmp610) + (K941544065 * tmp613);
		    tmp654 = (K427555093 * tmp603) + (K903989293 * tmp606);
		    tmp655 = tmp653 - tmp654;
		    tmp721 = tmp654 + tmp653;
		    tmp839 = (K242980179 * tmp814) - (K970031253 * tmp815);
		    tmp840 = (K514102744 * tmp811) - (K857728610 * tmp812);
		    tmp841 = tmp839 + tmp840;
		    tmp910 = tmp839 - tmp840;
	       }
	       tmp813 = (K857728610 * tmp811) + (K514102744 * tmp812);
	       tmp816 = (K970031253 * tmp814) + (K242980179 * tmp815);
	       tmp817 = tmp813 - tmp816;
	       tmp907 = tmp816 + tmp813;
	       {
		    fftw_real tmp806;
		    fftw_real tmp809;
		    fftw_real tmp836;
		    ...
		    tmp909 = tmp809 + tmp806;
		    tmp836 = (K989176509 * tmp804) - (K146730474 * tmp805);
		    tmp837 = (K595699304 * tmp807) + (K803207531 * tmp808);
		    tmp838 = tmp836 - tmp837;
		    tmp906 = tmp837 + tmp836;
	       }
	       {
		    fftw_real tmp472;
		    fftw_real tmp473;
		    ...
		    tmp285 = (K098017140 * tmp213) + (K995184726 * tmp222);
	       }
	       {
		    fftw_real tmp341;
		    fftw_real tmp342;
		    ...
		    tmp357 = (K290284677 * tmp341) + (K956940335 * tmp342);
		    tmp650 = (K049067674 * tmp595) + (K998795456 * tmp598);
		    tmp651 = (K671558954 * tmp588) + (K740951125 * tmp591);
		    tmp652 = tmp650 - tmp651;
		    tmp723 = tmp651 + tmp650;
	       }
	       tmp592 = (K740951125 * tmp588) - (K671558954 * tmp591);
	       tmp599 = (K998795456 * tmp595) - (K049067674 * tmp598);
	       tmp600 = tmp592 + tmp599;
	       tmp720 = tmp599 - tmp592;
	       {
		    fftw_real tmp232;
		    fftw_real tmp241;
		    fftw_real tmp344;
		    ...
		    tmp286 = (K634393284 * tmp232) + (K773010453 * tmp241);
		    tmp344 = tmp224 + tmp231;
		    tmp345 = tmp240 - tmp233;
		    tmp346 = (K471396736 * tmp344) + (K881921264 * tmp345);
		    tmp358 = (K881921264 * tmp344) - (K471396736 * tmp345);
	       }
	  }
     }
     {
     ...
     }
     {
	  ...
	  ASSERT_ALIGNED_DOUBLE;
	  {
	       ...
	       tmp303 = (K765366864 * tmp153) + (K1_847759065 * tmp162);
     ...
     }
     {
	  ...
	  ASSERT_ALIGNED_DOUBLE;
	  {
	       ...
	       tmp375 = (K1_847759065 * tmp329) + (K765366864 * tmp330);
	  ...
	  }
	  {
	       ...
	       tmp391 = K1_414213562 * (tmp378 + tmp377);
     ...
     }
     {
	  ...
	  fftw_real tmp649;
	  ASSERT_ALIGNED_DOUBLE;
	  tmp552 = K2_000000000 * (tmp536 + tmp551);
	  tmp672 = K2_000000000 * (tmp668 - tmp671);
	  tmp567 = K2_000000000 * (tmp559 + tmp566);
	  tmp583 = tmp574 + tmp582;
	  tmp584 = tmp567 + tmp583;
	  tmp665 = tmp583 - tmp567;
	  {
	       fftw_real tmp616;
	       fftw_real tmp647;
	       fftw_real tmp656;
	  ...
	  tmp585 = tmp552 + tmp584;
	  output[65 * ostride] = tmp585 - tmp648;
	  output[ostride] = tmp648 + tmp585;
	  tmp649 = tmp584 - tmp552;
	  output[33 * ostride] = tmp649 - tmp664;
	  output[97 * ostride] = tmp664 + tmp649;
	  {
	       fftw_real tmp673;
	       fftw_real tmp676;
	       fftw_real tmp677;
	       ...
	       output[17 * ostride] = tmp676 + tmp673;
	       tmp677 = tmp672 + tmp665;
	       tmp678 = K1_414213562 * (tmp674 + tmp675);
	       output[49 * ostride] = tmp677 - tmp678;
	       output[113 * ostride] = tmp678 + tmp677;
	  }
     }
     {
	  fftw_real tmp681;
	  ...
	  ASSERT_ALIGNED_DOUBLE;
	  {
	       ...
	       fftw_real tmp692;
	       ASSERT_ALIGNED_DOUBLE;
	       tmp679 = tmp536 - tmp551;
	       tmp680 = tmp668 + tmp671;
	       tmp681 = K1_414213562 * (tmp679 - tmp680);
	       tmp698 = K1_414213562 * (tmp679 + tmp680);
	  ...
	  }
	  {
	       ...
	       fftw_real tmp689;
	       ASSERT_ALIGNED_DOUBLE;
	       tmp682 = tmp582 - tmp574;
	       tmp685 = K2_000000000 * (tmp683 - tmp684);
	       tmp686 = tmp682 - tmp685;
	       tmp697 = tmp685 + tmp682;
	  ...
	  }
	  {
	       ...
	       output[25 * ostride] = tmp702 + tmp699;
	       tmp703 = tmp698 + tmp697;
	       tmp704 = (K765366864 * tmp701) + (K1_847759065 * tmp700);
	       output[57 * ostride] = tmp703 - tmp704;
	       output[121 * ostride] = tmp704 + tmp703;
	  }
     }
     {
	  fftw_real tmp711;
	  ...
	  ASSERT_ALIGNED_DOUBLE;
	  {
	       ...
	       tmp711 = (K1_847759065 * tmp707) - (K765366864 * tmp710);
	       tmp740 = (K1_847759065 * tmp710) + (K765366864 * tmp707);
	       tmp714 = K1_414213562 * (tmp712 - tmp713);
	       tmp717 = tmp715 - tmp716;
	       tmp718 = tmp714 + tmp717;
	  ...
	  }
	  {
	       ...
	       output[5 * ostride] = tmp734 + tmp719;
	       tmp735 = tmp718 - tmp711;
	       tmp738 = K2_000000000 * (tmp736 - tmp737);
	       output[37 * ostride] = tmp735 - tmp738;
	       output[101 * ostride] = tmp738 + tmp735;
	  }
	  {
	       fftw_real tmp741;
	       fftw_real tmp744;
	       ...
	       output[21 * ostride] = tmp744 + tmp741;
	       tmp745 = tmp740 + tmp739;
	       tmp746 = K1_414213562 * (tmp742 + tmp743);
	       output[53 * ostride] = tmp745 - tmp746;
	       output[117 * ostride] = tmp746 + tmp745;
	  }
     }
     {
	  fftw_real tmp749;
	  ...
	  ASSERT_ALIGNED_DOUBLE;
	  {
	       ...
	       tmp748 = tmp708 - tmp709;
	       tmp749 = (K765366864 * tmp747) - (K1_847759065 * tmp748);
	       tmp766 = (K765366864 * tmp748) + (K1_847759065 * tmp747);
	       tmp750 = tmp716 + tmp715;
	       tmp751 = K1_414213562 * (tmp712 + tmp713);
	       tmp752 = tmp750 - tmp751;
	       tmp765 = tmp751 + tmp750;
	       {
		    fftw_real tmp754;
		    fftw_real tmp755;
		    fftw_real tmp757;
	  ...
	  }
	  {
	       ...
	       output[13 * ostride] = tmp760 + tmp753;
	       tmp761 = tmp752 - tmp749;
	       tmp764 = K2_000000000 * (tmp762 - tmp763);
	       output[45 * ostride] = tmp761 - tmp764;
	       output[109 * ostride] = tmp764 + tmp761;
	  }
	  {
	       fftw_real tmp767;
	       fftw_real tmp770;
	       ...
	       output[29 * ostride] = tmp770 + tmp767;
	       tmp771 = tmp766 + tmp765;
	       tmp772 = K1_414213562 * (tmp768 + tmp769);
	       output[61 * ostride] = tmp771 - tmp772;
	       output[125 * ostride] = tmp772 + tmp771;
	  }
     }
     {
	  fftw_real tmp802;
	  ...
	  tmp858 = K2_000000000 * (tmp854 - tmp857);
	  tmp779 = K2_000000000 * (tmp775 - tmp778);
	  tmp786 = tmp782 + tmp785;
	  tmp787 = tmp779 + tmp786;
	  tmp851 = tmp786 - tmp779;
	  {
	       fftw_real tmp818;
	       fftw_real tmp833;
	       fftw_real tmp842;
	       ...
	       tmp861 = tmp818 + tmp833;
	       tmp842 = tmp838 + tmp841;
	       tmp849 = tmp845 + tmp848;
	       tmp850 = K2_000000000 * (tmp842 + tmp849);
	       tmp860 = tmp842 - tmp849;
	  }
	  tmp803 = tmp787 - tmp802;
	  output[35 * ostride] = tmp803 - tmp834;
	  output[99 * ostride] = tmp834 + tmp803;
	  tmp835 = tmp802 + tmp787;
	  output[67 * ostride] = tmp835 - tmp850;
	  output[3 * ostride] = tmp850 + tmp835;
	  {
	       fftw_real tmp859;
	       fftw_real tmp862;
	       fftw_real tmp863;
	       fftw_real tmp864;
	       ASSERT_ALIGNED_DOUBLE;
	       tmp859 = tmp851 - tmp858;
	       tmp862 = K1_414213562 * (tmp860 - tmp861);
	       output[83 * ostride] = tmp859 - tmp862;
	       output[19 * ostride] = tmp862 + tmp859;
	       tmp863 = tmp858 + tmp851;
	       tmp864 = K1_414213562 * (tmp860 + tmp861);
	       output[51 * ostride] = tmp863 - tmp864;
	       output[115 * ostride] = tmp864 + tmp863;
	  }
     }
     {
	  fftw_real tmp869;
	  ...
	  ASSERT_ALIGNED_DOUBLE;
	  {
	       ...
	       fftw_real tmp878;
	       ASSERT_ALIGNED_DOUBLE;
	       tmp867 = K2_000000000 * (tmp865 - tmp866);
	       tmp868 = tmp785 - tmp782;
	       tmp869 = tmp867 + tmp868;
	       tmp884 = tmp868 - tmp867;
	       tmp877 = tmp810 + tmp817;
	       tmp878 = tmp848 - tmp845;
	  ...
	  }
	  {
	       ...
	       tmp871 = tmp854 + tmp857;
	       tmp872 = K1_414213562 * (tmp870 + tmp871);
	       tmp883 = K1_414213562 * (tmp870 - tmp871);
	       tmp874 = tmp838 - tmp841;
	  ...
	  }
	  {
	       ...
	       output[27 * ostride] = tmp880 + tmp873;
	       tmp881 = tmp872 + tmp869;
	       tmp882 = (K765366864 * tmp879) + (K1_847759065 * tmp876);
	       output[59 * ostride] = tmp881 - tmp882;
	       output[123 * ostride] = tmp882 + tmp881;
	  }
	  {
	       fftw_real tmp885;
	       fftw_real tmp888;
	       ...
	       output[11 * ostride] = tmp888 + tmp885;
	       tmp889 = tmp884 - tmp883;
	       tmp890 = (K1_847759065 * tmp887) + (K765366864 * tmp886);
	       output[43 * ostride] = tmp889 - tmp890;
	       output[107 * ostride] = tmp890 + tmp889;
	  }
     }
     {
	  fftw_real tmp897;
	  ...
	  ASSERT_ALIGNED_DOUBLE;
	  {
	       ...
	       tmp897 = (K1_847759065 * tmp893) - (K765366864 * tmp896);
	       tmp926 = (K1_847759065 * tmp896) + (K765366864 * tmp893);
	       tmp900 = K1_414213562 * (tmp898 - tmp899);
	       tmp903 = tmp901 - tmp902;
	       tmp904 = tmp900 + tmp903;
	       tmp925 = tmp903 - tmp900;
	       {
		    fftw_real tmp908;
		    fftw_real tmp911;
		    fftw_real tmp915;
		    ...
		    tmp923 = (K831469612 * tmp918) + (K555570233 * tmp915);
	       }
	  ...
	  }
	  {
	       ...
	       output[7 * ostride] = tmp920 + tmp905;
	       tmp921 = tmp904 - tmp897;
	       tmp924 = K2_000000000 * (tmp922 - tmp923);
	       output[39 * ostride] = tmp921 - tmp924;
	       output[103 * ostride] = tmp924 + tmp921;
	  }
	  {
	       fftw_real tmp927;
	       fftw_real tmp930;
	       ...
	       output[23 * ostride] = tmp930 + tmp927;
	       tmp931 = tmp926 + tmp925;
	       tmp932 = K1_414213562 * (tmp928 + tmp929);
	       output[55 * ostride] = tmp931 - tmp932;
	       output[119 * ostride] = tmp932 + tmp931;
	  }
     }
     {
	  fftw_real tmp935;
	  ...
	  ASSERT_ALIGNED_DOUBLE;
	  {
	       ...
	       fftw_real tmp937;
	       ASSERT_ALIGNED_DOUBLE;
	       tmp933 = tmp902 + tmp901;
	       tmp934 = K1_414213562 * (tmp898 + tmp899);
	       tmp935 = tmp933 - tmp934;
	       tmp951 = tmp934 + tmp933;
	       tmp936 = tmp891 + tmp892;
	       tmp937 = tmp894 - tmp895;
	       ...
	       tmp952 = (K765366864 * tmp937) + (K1_847759065 * tmp936);
	       {
		    ...
		    tmp949 = (K980785280 * tmp944) + (K195090322 * tmp943);
	       }
	  ...
	  }
	  {
	       ...
	       output[111 * ostride] = tmp946 + tmp939;
	       tmp947 = tmp938 + tmp935;
	       tmp950 = K2_000000000 * (tmp948 - tmp949);
	       output[79 * ostride] = tmp947 - tmp950;
	       output[15 * ostride] = tmp950 + tmp947;
	  }
	  {
	       fftw_real tmp953;
	       fftw_real tmp956;
	       ...
	       output[31 * ostride] = tmp956 + tmp953;
	       tmp957 = tmp952 + tmp951;
	       tmp958 = K1_414213562 * (tmp955 + tmp954);
	       output[63 * ostride] = tmp957 - tmp958;
	       output[127 * ostride] = tmp958 + tmp957;
	  }
     }
}
