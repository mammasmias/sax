...
/* $Id: executor.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $ */
#include "fftw-int.h"
#include <stdio.h>
#include <stdlib.h>

const char *fftw_version = "FFTW V" FFTW_VERSION " ($Id: executor.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $)";
