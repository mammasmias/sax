...
/* Generated on Mon Mar 24 02:08:55 EST 2003 */

#include "fftw-int.h"
#include "fftw.h"

/* Generated by: /homee/stevenj/cvs/fftw/gensrc/genfft -magic-alignment-check -magic-twiddle-load-all -magic-variables 4 -magic-loopi -hc2hc-backward 8 */
...
/*
 * Generator Id's : 
 * $Id: fhb_8.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: fhb_8.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 * $Id: fhb_8.c,v 1.1.1.1 2004/12/28 16:08:07 software Exp $
 */

void fftw_hc2hc_backward_8(fftw_real *A, const fftw_complex *W,
			   int iostride, int m, int dist)
{
     ...
     if (i == m) {
	  ...
	  X[4 * iostride] = -(K2_000000000 * (tmp21 + tmp20));
	  {
	       ...
	       X[5 * iostride] =
		   -((K765366864 * tmp11) + (K1_847759065 * tmp16));
	       tmp17 = tmp7 + tmp10;
	       tmp18 = tmp15 - tmp12;
	       X[3 * iostride] =
		   (K765366864 * tmp17) - (K1_847759065 * tmp18);
	       X[7 * iostride] =
		   -((K1_847759065 * tmp17) + (K765366864 * tmp18));
	  }
     }
}
