...
#ifdef __PTK_MPI
  call MPI_Bcast(buffer,1,__PTK_MPI_LOGICAL2, &
...
#ifdef __PTK_MPI
  call MPI_Send(buffer,1,__PTK_MPI_LOGICAL2, &
...
subroutine ptk_recv_LOGICAL2_0(buffer,source,tag,comm,status,ierr)
  ...
  if(present(comm)) comm_loc = comm
#ifdef __PTK_MPI
  call MPI_Recv(buffer,1,__PTK_MPI_LOGICAL2, &
...
#ifdef __PTK_MPI
  call MPI_Reduce(sendbuf,recvbuf,1,__PTK_MPI_LOGICAL2, &
...
subroutine ptk_allreduce_LOGICAL2_0(sendbuf,recvbuf,op,comm,ierr)
  ...
  if(ierr_loc/=0) goto 1
#ifdef __PTK_MPI
  call MPI_Allreduce(sendbuf,recvbuf,1,__PTK_MPI_LOGICAL2, &
...
# 280 "ptk_multitype.spp"
  LOGICAL (kind=__PTK_LOGICAL2) :: tempbuf 
# 282 "ptk_multitype.spp"
  ...
  if(present(comm)) comm_loc = comm
#ifdef __PTK_MPI
  call MPI_Reduce(buffer,tempbuf,1,__PTK_MPI_LOGICAL2, &
                  op%op,root_loc,comm_loc%comm,ierr_loc)
  if(ierr_loc/=0) goto 1
...
# 320 "ptk_multitype.spp"
  ...
  if(present(comm)) comm_loc = comm
#ifdef __PTK_MPI
  call MPI_Allreduce(buffer,tempbuf,1,__PTK_MPI_LOGICAL2, &
                     op%op,comm_loc%comm,ierr_loc)
  if(ierr_loc/=0) goto 1
  buffer = tempbuf
#endif
...
subroutine ptk_gather_LOGICAL2_0(sendbuf,recvbuf,root,comm,ierr)
  ...
  if(ierr_loc/=0) goto 1
#ifdef __PTK_MPI
  call MPI_Gather(sendbuf,1,__PTK_MPI_LOGICAL2, &
                  recvbuf,1,__PTK_MPI_LOGICAL2, &
                  root_loc,comm_loc%comm,ierr_loc)
#else
...
subroutine ptk_allgather_LOGICAL2_0(sendbuf,recvbuf,comm,ierr)
  ...
  if(ierr_loc/=0) goto 1
#ifdef __PTK_MPI
  call MPI_Allgather(sendbuf,1,__PTK_MPI_LOGICAL2, &
                     recvbuf,1,__PTK_MPI_LOGICAL2, &
...
subroutine ptk_dummy_LOGICAL2_0
write(0,*)
end subroutine ptk_dummy_LOGICAL2_0
...
subroutine ptk_reduce_ip_LOGICAL2_1(buffer,op,root,comm,ierr)
  ...
  type(ptk_comm) :: comm_loc
# 280 "ptk_multitype.spp"
  LOGICAL (kind=__PTK_LOGICAL2) :: tempbuf (lbound(buffer,1):ubound(buffer,1))
# 282 "ptk_multitype.spp"
  ierr_loc = 0
  root_loc = 0
  if(present(root)) root_loc = root
...
subroutine ptk_dummy_LOGICAL2_1
write(0,*)
end subroutine ptk_dummy_LOGICAL2_1
...
subroutine ptk_dummy_LOGICAL2_2
write(0,*)
end subroutine ptk_dummy_LOGICAL2_2
