...
\newcommand{\SAXNAME} {Self-energy and eXcitaions}
\newcommand{\WANTNAME} {Wannier Transport}
\newcommand{\SAXDATE} {\today}
%\newcommand{\WANTDATE} {October 2005}
\newcommand{\UGAUTHORS} {
L. Martin-Samos  and G. Bussi}
\newcommand{\SAXVERSION} {2.0.0}
\newcommand{\WANTVERSION} {2.0.0}
\newcommand{\SAXURL} {\texttt{http://www.sax-project.org}}
%
% other cited codes
\newcommand{\PWSCF} { \textsc{pw.x}{ }}
\newcommand{\ESPRESSO} {\textsc{Quantum ESPRESSO}{}}
\newcommand{\PWSCFURL} {\texttt {http://www.quantum-espresso.org}{}}
\newcommand{\ESPRESSOURL} {\texttt {http://www.quantum-espresso.org}{}}
...
\newcommand{\UGDESC} {\noindent This {\em\UGTITLE\/} covers the installation and usage of \SAX
(Self-energies and eXcitations), version \SAXVERSION. It includes a
description of the capabilities of the package, how to use these
capabilities, the necessary input files and formats, and how to
run the programs contained in the package on both serial and parallel machines.}
